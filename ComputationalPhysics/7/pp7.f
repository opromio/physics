...
!     Vectors      
      ...
      OPEN(UNIT=10, STATUS='UNKNOWN', FILE='P7-2016-res.dat')
...
!D2)  !INDEX8
      ...
      DT=(TMAX-T0)/DBLE(NDAT-1)
      THETA0=0.d0
      DTHETA0=(2.d0*DSQRT(G/L))+0.001d0
      CALL BETTERCALLEULER(10, THETA0, DTHETA0)
      !INDEX9
      THETA0=0.d0
      DTHETA0=(2.d0*DSQRT(G/L))-0.001d0
      CALL BETTERCALLEULER(10, THETA0, DTHETA0)  
!E)   !INDEX 10, 11, 12 I 13
      WRITE(10,*)'#APARTAT E:'
      TMAX=10.d0*TN
      NP=(/500,1000,2000,20000/)
      DO I=1,4
        NDAT=NP(I)
        DT=(TMAX-T0)/DBLE(NDAT-1)
        WRITE(10,*)'#NDAT= ', NDAT
      ...
      CLOSE(10)
!F)
      OPEN(UNIT=20, STATUS='UNKNOWN', FILE='Figura7.dat')
      WRITE(20,*)'#APARTAT F:'
      DO I=1, 100
        NDAT=I*500
        DT=(TMAX-T0)/DBLE(NDAT-1)
